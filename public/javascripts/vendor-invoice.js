//* Global Varibales
const vendorForm = document.forms.vendorForm,
  ...
  vendorSideBar = document.getElementById("vendor-side-container");

//* Overlay and Sidebar

function showVendorSidebar() {
  vendorSideBar.classList.add("toggle");
  overlay.classList.add("toggle");
}
function hideVendorSidebar() {
  vendorSideBar.classList.remove("toggle");
